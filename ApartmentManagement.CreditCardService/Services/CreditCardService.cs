using ApartmentManagement.CreditCardService.Configuration;
using ApartmentManagement.CreditCardService.Model.Mongo;
...
namespace ApartmentManagement.CreditCardService.Services
{
